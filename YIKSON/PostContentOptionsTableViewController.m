...
//
//  PostContentOptionsTableViewController.m
//  YIKSON
//
...
#import "PostContentOptionsTableViewController.h"
#import "DirectUploadViewController.h"

@interface PostContentOptionsTableViewController ()
@property NSString * directUploadTitleString;
@property NSArray * directDownloadOptions;
@end

@implementation PostContentOptionsTableViewController
...
- (void)viewDidLoad {
    ...
    _directDownloadOptions = @[@"UPLOAD IMAGE",@"UPLOAD GIF",@"UPLOAD VIDEO"];
}
